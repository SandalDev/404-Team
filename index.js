import{S as A,a as B,i as l,A as K}from"./assets/vendor-Cw8gnIhn.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const i of o.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&n(i)}).observe(document,{childList:!0,subtree:!0});function a(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function n(s){if(s.ep)return;s.ep=!0;const o=a(s);fetch(s.href,o)}})();new A(".about-swiper",{loop:!0,pagination:{el:".about-controls .swiper-pagination",clickable:!0},navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}});let p;async function _(){return(await B.get("https://paw-hut.b.goit.study/api/categories")).data}async function y(e=1){p=window.innerWidth<1440?8:9;const a="https://paw-hut.b.goit.study/api/animals",n={page:e,limit:p};try{return(await B.get(a,{params:n})).data}catch(s){return console.error("Error:",s),[]}}async function T(e,t=1){p=window.innerWidth<1440?8:9;const n="https://paw-hut.b.goit.study/api/animals",s={page:t,limit:p,categoryId:e};try{const o=await B.get(n,{params:s});return console.log(o.data),o.data}catch(o){return console.error("Error:",o),[]}}const c={categories:document.querySelector(".pets-categories"),petsList:document.querySelector(".pets-list"),showMore:document.querySelector(".show-more"),loader:document.querySelector(".js-loader")};let u=1,h,M="all",v,N,w=[];function D(e){const t=S(e);c.petsList.insertAdjacentHTML("beforeend",t)}async function Q(){if(u++,I(),M==="all")try{const e=await y(u);w.push(...e.animals),D(e.animals),h=Math.ceil(e.totalItems/v),L()}catch{l.show({message:"Something went wrong. Please try again later.",color:"red",position:"topRight",messageSize:"20",timeout:"4000",theme:"dark"})}else if(M==="category"){try{const e=await T(N,u);w.push(...e.animals),D(e.animals),h=Math.ceil(e.totalItems/v),L()}catch{l.show({message:"Something went wrong. Please try again later.",color:"red",position:"topRight",messageSize:"20",timeout:"4000",theme:"dark"})}z()}}c.showMore.addEventListener("click",Q);document.addEventListener("DOMContentLoaded",async e=>{x(),I();try{const t=await _(),a=i=>Number(i._id.at(-1));t.sort((i,J)=>a(i)-a(J)),t.unshift({_id:0,name:"Всі"});const n=Z(t);c.categories.innerHTML=n,c.categories.firstElementChild.firstElementChild.classList.add("active")}catch{l.show({message:"Something went wrong. Please try again later.",color:"red",position:"topRight",messageSize:"20",timeout:"4000",theme:"dark"})}M="all",u=1;try{const t=await y();w=t.animals;const a=S(t.animals);c.petsList.innerHTML=a,h=Math.ceil(t.totalItems/v),console.log(h),z(),L()}catch{l.show({message:"Something went wrong. Please try again later.",color:"red",position:"topRight",messageSize:"20",timeout:"4000",theme:"dark"})}});c.categories.addEventListener("click",async e=>{x(),I(),M="category",u=1;const t=document.querySelector(".active");t.classList.remove("active"),console.log(t);const a=e.target.closest("button");a.classList.add("active");const n=a.dataset.id;if(N=n,n==="0")try{const s=await y(u);w=s.animals;const o=S(s.animals);h=Math.ceil(s.totalItems/v),c.petsList.innerHTML=o,L()}catch{l.show({message:"Something went wrong. Please try again later.",color:"red",position:"topRight",messageSize:"20",timeout:"4000",theme:"dark"})}else try{const s=await T(n,u);w=s.animals;const o=S(s.animals);h=Math.ceil(s.totalItems/v),c.petsList.innerHTML=o}catch{l.show({message:"Something went wrong. Please try again later.",color:"red",position:"topRight",messageSize:"20",timeout:"4000",theme:"dark"})}L(),z()});function U(){c.showMore.classList.remove("is-hidden")}function X(){c.showMore.classList.add("is-hidden")}function L(){u<h?U():X()}function x(){c.petsList.innerHTML=""}function I(){c.loader.classList.remove("hidden"),c.showMore.classList.add("hidden")}function z(){c.loader.classList.add("hidden"),c.showMore.classList.remove("hidden")}function Y(e){return`<li class="category-name">
    ...
    </li>`}function $(e){return e.map(me).join("")}r.petsList.addEventListener("click",async e=>{const t=e.target.closest("li");console.log(t),console.log("something");const a=t.dataset.id;if(console.log(a),!a||a==="undefined"){console.error("Invalid data-id on pet card");return}const n=w;console.log(n);const s=n.find(i=>i._id===a);if(console.log(s),!s){console.error("Pet not found");return}const o=pe(s);r.modal.innerHTML=o,ue()});r.modalCloseBtn.addEventListener("click",e=>{e.target===e.currentTarget&&C()});r.backdrop.addEventListener("click",e=>{e.target===e.currentTarget&&C()});function G(e){if(e.code==="Escape")C();else return}function pe(e){return`<img src="${e.image}" class="modalpet-img" alt="${e.shortDescription}" />
